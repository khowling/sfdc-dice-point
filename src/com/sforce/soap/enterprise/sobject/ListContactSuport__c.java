 ...
 */
public class ListContactSuport__c extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public ListContactSuport__c() {}
    ...
    /**
     * element : Support__c of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Support__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Support__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean Support__c__is_set = false;
    ...
    public void setSupport__c(java.lang.String Support__c) {
      ...
      Support__c__is_set = true;
    }

    /**
     * element : Support__r of type {urn:sobject.enterprise.soap.sforce.com}Suport__c
     * java type: com.sforce.soap.enterprise.sobject.Suport__c
     */
    private static final com.sforce.ws.bind.TypeInfo Support__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Support__r","urn:sobject.enterprise.soap.sforce.com","Suport__c",0,1,true);

    private boolean Support__r__is_set = false;

    private com.sforce.soap.enterprise.sobject.Suport__c Support__r;

    public com.sforce.soap.enterprise.sobject.Suport__c getSupport__r() {
      return Support__r;
    }

    public void setSupport__r(com.sforce.soap.enterprise.sobject.Suport__c Support__r) {
      this.Support__r = Support__r;
      Support__r__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "ListContactSuport__c");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeString(__out, Support__c__typeInfo, Support__c, Support__c__is_set);
       __typeMapper.writeObject(__out, Support__r__typeInfo, Support__r, Support__r__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Support__c__typeInfo)) {
            setSupport__c(__typeMapper.readString(__in, Support__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Support__r__typeInfo)) {
            setSupport__r((com.sforce.soap.enterprise.sobject.Suport__c)__typeMapper.readObject(__in, Support__r__typeInfo, com.sforce.soap.enterprise.sobject.Suport__c.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[ListContactSuport__c ");
      ...
      sb.append(" Support__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Support__c)+"'\n");
      sb.append(" Support__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Support__r)+"'\n");

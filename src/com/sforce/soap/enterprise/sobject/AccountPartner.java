...
public class AccountPartner extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, AccountFromId__typeInfo)) {
            setAccountFromId(__typeMapper.readString(__in, AccountFromId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, AccountToId__typeInfo)) {
            setAccountToId(__typeMapper.readString(__in, AccountToId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, ReversePartnerId__typeInfo)) {
            setReversePartnerId(__typeMapper.readString(__in, ReversePartnerId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Role__typeInfo)) {
            setRole(__typeMapper.readString(__in, Role__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" AccountFrom=");

 ...
 */
public class Customer_Product__c extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public Customer_Product__c() {}
    ...
    /**
     * element : Product_SKUs__r of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo Product_SKUs__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Product_SKUs__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean Product_SKUs__r__is_set = false;

    private com.sforce.soap.enterprise.QueryResult Product_SKUs__r;

    public com.sforce.soap.enterprise.QueryResult getProduct_SKUs__r() {
      return Product_SKUs__r;
    }

    public void setProduct_SKUs__r(com.sforce.soap.enterprise.QueryResult Product_SKUs__r) {
      this.Product_SKUs__r = Product_SKUs__r;
      Product_SKUs__r__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Customer_Product__c");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, Product_SKUs__r__typeInfo, Product_SKUs__r, Product_SKUs__r__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, Account__c__typeInfo)) {
            setAccount__c(__typeMapper.readString(__in, Account__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Product_SKUs__r__typeInfo)) {
            setProduct_SKUs__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Product_SKUs__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" Account__c=");
      ...
      sb.append(" Product_SKUs__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Product_SKUs__r)+"'\n");

...
public class LoginHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, ApiType__typeInfo)) {
            setApiType(__typeMapper.readString(__in, ApiType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ApiVersion__typeInfo)) {
            setApiVersion(__typeMapper.readString(__in, ApiVersion__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Browser__typeInfo)) {
            setBrowser(__typeMapper.readString(__in, Browser__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ClientVersion__typeInfo)) {
            setClientVersion(__typeMapper.readString(__in, ClientVersion__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Platform__typeInfo)) {
            setPlatform(__typeMapper.readString(__in, Platform__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" ApiType=");

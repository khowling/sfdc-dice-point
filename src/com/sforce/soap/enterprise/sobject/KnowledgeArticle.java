 ...
 */
public class KnowledgeArticle extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : VersionHistories of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo VersionHistories__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VersionHistories","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean VersionHistories__is_set = false;

    private com.sforce.soap.enterprise.QueryResult VersionHistories;

    public com.sforce.soap.enterprise.QueryResult getVersionHistories() {
      return VersionHistories;
    }

    public void setVersionHistories(com.sforce.soap.enterprise.QueryResult VersionHistories) {
      this.VersionHistories = VersionHistories;
      VersionHistories__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "KnowledgeArticle");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, VersionHistories__typeInfo, VersionHistories, VersionHistories__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, VersionHistories__typeInfo)) {
            setVersionHistories((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, VersionHistories__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" VersionHistories=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(VersionHistories)+"'\n");
      sb.append(" ViewStats=");

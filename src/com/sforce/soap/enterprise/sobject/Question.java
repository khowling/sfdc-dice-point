...
public class Question extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, BestReplyId__typeInfo)) {
            setBestReplyId(__typeMapper.readString(__in, BestReplyId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, BestReplySelectedById__typeInfo)) {
            setBestReplySelectedById(__typeMapper.readString(__in, BestReplySelectedById__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, LastReplyId__typeInfo)) {
            setLastReplyId(__typeMapper.readString(__in, LastReplyId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[Question ");
      sb.append(super.toString());sb.append(" BestReply=");

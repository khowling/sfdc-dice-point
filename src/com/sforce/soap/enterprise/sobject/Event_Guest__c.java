 ...
 */
public class Event_Guest__c extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public Event_Guest__c() {}
    ...
    /**
     * element : Master_Event__c of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Master_Event__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Master_Event__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean Master_Event__c__is_set = false;

    private java.lang.String Master_Event__c;

    public java.lang.String getMaster_Event__c() {
      return Master_Event__c;
    }

    public void setMaster_Event__c(java.lang.String Master_Event__c) {
      this.Master_Event__c = Master_Event__c;
      Master_Event__c__is_set = true;
    }

    /**
     * element : Master_Event__r of type {urn:sobject.enterprise.soap.sforce.com}Event__c
     * java type: com.sforce.soap.enterprise.sobject.Event__c
     */
    private static final com.sforce.ws.bind.TypeInfo Master_Event__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Master_Event__r","urn:sobject.enterprise.soap.sforce.com","Event__c",0,1,true);

    private boolean Master_Event__r__is_set = false;

    private com.sforce.soap.enterprise.sobject.Event__c Master_Event__r;

    public com.sforce.soap.enterprise.sobject.Event__c getMaster_Event__r() {
      return Master_Event__r;
    }

    public void setMaster_Event__r(com.sforce.soap.enterprise.sobject.Event__c Master_Event__r) {
      this.Master_Event__r = Master_Event__r;
      Master_Event__r__is_set = true;
    }
    ...
    /**
     * element : User_guest__c of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo User_guest__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","User_guest__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean User_guest__c__is_set = false;

    private java.lang.String User_guest__c;

    public java.lang.String getUser_guest__c() {
      return User_guest__c;
    }

    public void setUser_guest__c(java.lang.String User_guest__c) {
      this.User_guest__c = User_guest__c;
      User_guest__c__is_set = true;
    }

    /**
     * element : User_guest__r of type {urn:sobject.enterprise.soap.sforce.com}User
     * java type: com.sforce.soap.enterprise.sobject.User
     */
    private static final com.sforce.ws.bind.TypeInfo User_guest__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","User_guest__r","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

    private boolean User_guest__r__is_set = false;

    private com.sforce.soap.enterprise.sobject.User User_guest__r;

    public com.sforce.soap.enterprise.sobject.User getUser_guest__r() {
      return User_guest__r;
    }

    public void setUser_guest__r(com.sforce.soap.enterprise.sobject.User User_guest__r) {
      this.User_guest__r = User_guest__r;
      User_guest__r__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Event_Guest__c");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeString(__out, Master_Event__c__typeInfo, Master_Event__c, Master_Event__c__is_set);
       __typeMapper.writeObject(__out, Master_Event__r__typeInfo, Master_Event__r, Master_Event__r__is_set);
       ...
       __typeMapper.writeString(__out, User_guest__c__typeInfo, User_guest__c, User_guest__c__is_set);
       __typeMapper.writeObject(__out, User_guest__r__typeInfo, User_guest__r, User_guest__r__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Master_Event__c__typeInfo)) {
            setMaster_Event__c(__typeMapper.readString(__in, Master_Event__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Master_Event__r__typeInfo)) {
            setMaster_Event__r((com.sforce.soap.enterprise.sobject.Event__c)__typeMapper.readObject(__in, Master_Event__r__typeInfo, com.sforce.soap.enterprise.sobject.Event__c.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, User_guest__c__typeInfo)) {
            setUser_guest__c(__typeMapper.readString(__in, User_guest__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, User_guest__r__typeInfo)) {
            setUser_guest__r((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, User_guest__r__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append(" Master_Event__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Master_Event__c)+"'\n");
      sb.append(" Master_Event__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Master_Event__r)+"'\n");
      sb.append(" Name=");
      ...
      sb.append(" User_guest__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(User_guest__c)+"'\n");
      sb.append(" User_guest__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(User_guest__r)+"'\n");
      sb.append("]\n");
      return sb.toString();
    }
}

...
public class UserRecordAccess extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, MaxAccessLevel__typeInfo)) {
            setMaxAccessLevel(__typeMapper.readString(__in, MaxAccessLevel__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, RecordId__typeInfo)) {
            setRecordId(__typeMapper.readString(__in, RecordId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" HasAllAccess=");

...
public class EmailServicesFunction extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, AddressInactiveAction__typeInfo)) {
            setAddressInactiveAction(__typeMapper.readString(__in, AddressInactiveAction__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, AttachmentOption__typeInfo)) {
            setAttachmentOption(__typeMapper.readString(__in, AttachmentOption__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, AuthenticationFailureAction__typeInfo)) {
            setAuthenticationFailureAction(__typeMapper.readString(__in, AuthenticationFailureAction__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, AuthorizationFailureAction__typeInfo)) {
            setAuthorizationFailureAction(__typeMapper.readString(__in, AuthorizationFailureAction__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, ErrorRoutingAddress__typeInfo)) {
            setErrorRoutingAddress(__typeMapper.readString(__in, ErrorRoutingAddress__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, FunctionInactiveAction__typeInfo)) {
            setFunctionInactiveAction(__typeMapper.readString(__in, FunctionInactiveAction__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, FunctionName__typeInfo)) {
            setFunctionName(__typeMapper.readString(__in, FunctionName__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, OverLimitAction__typeInfo)) {
            setOverLimitAction(__typeMapper.readString(__in, OverLimitAction__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" AddressInactiveAction=");

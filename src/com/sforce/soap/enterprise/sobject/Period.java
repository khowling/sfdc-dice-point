...
public class Period extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, FiscalYearSettingsId__typeInfo)) {
            setFiscalYearSettingsId(__typeMapper.readString(__in, FiscalYearSettingsId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, PeriodLabel__typeInfo)) {
            setPeriodLabel(__typeMapper.readString(__in, PeriodLabel__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, QuarterLabel__typeInfo)) {
            setQuarterLabel(__typeMapper.readString(__in, QuarterLabel__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[Period ");
      sb.append(super.toString());sb.append(" EndDate=");

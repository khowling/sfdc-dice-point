...
public class FiscalYearSettings extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, PeriodLabelScheme__typeInfo)) {
            setPeriodLabelScheme(__typeMapper.readString(__in, PeriodLabelScheme__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, PeriodPrefix__typeInfo)) {
            setPeriodPrefix(__typeMapper.readString(__in, PeriodPrefix__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, QuarterLabelScheme__typeInfo)) {
            setQuarterLabelScheme(__typeMapper.readString(__in, QuarterLabelScheme__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, QuarterPrefix__typeInfo)) {
            setQuarterPrefix(__typeMapper.readString(__in, QuarterPrefix__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, WeekLabelScheme__typeInfo)) {
            setWeekLabelScheme(__typeMapper.readString(__in, WeekLabelScheme__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, YearType__typeInfo)) {
            setYearType(__typeMapper.readString(__in, YearType__typeInfo, java.lang.String.class));
        }
    }

...
public class SetupEntityAccess extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, SetupEntityId__typeInfo)) {
            setSetupEntityId(__typeMapper.readString(__in, SetupEntityId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, SetupEntityType__typeInfo)) {
            setSetupEntityType(__typeMapper.readString(__in, SetupEntityType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" Parent=");

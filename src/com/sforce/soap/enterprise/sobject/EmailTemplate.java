...
public class EmailTemplate extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, BrandTemplateId__typeInfo)) {
            setBrandTemplateId(__typeMapper.readString(__in, BrandTemplateId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, HtmlValue__typeInfo)) {
            setHtmlValue(__typeMapper.readString(__in, HtmlValue__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Markup__typeInfo)) {
            setMarkup(__typeMapper.readString(__in, Markup__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, TemplateStyle__typeInfo)) {
            setTemplateStyle(__typeMapper.readString(__in, TemplateStyle__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, TemplateType__typeInfo)) {
            setTemplateType(__typeMapper.readString(__in, TemplateType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();

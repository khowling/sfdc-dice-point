...
public class EmailStatus extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, EmailTemplateName__typeInfo)) {
            setEmailTemplateName(__typeMapper.readString(__in, EmailTemplateName__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, TaskId__typeInfo)) {
            setTaskId(__typeMapper.readString(__in, TaskId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();

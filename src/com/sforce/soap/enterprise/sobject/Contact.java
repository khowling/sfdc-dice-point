...
public class Contact extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : CanAllowPortalSelfReg of type {http://www.w3.org/2001/XMLSchema}boolean
     * java type: java.lang.Boolean
     */
    private static final com.sforce.ws.bind.TypeInfo CanAllowPortalSelfReg__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CanAllowPortalSelfReg","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

    private boolean CanAllowPortalSelfReg__is_set = false;

    private java.lang.Boolean CanAllowPortalSelfReg;

    public java.lang.Boolean getCanAllowPortalSelfReg() {
      return CanAllowPortalSelfReg;
    }

    public void setCanAllowPortalSelfReg(java.lang.Boolean CanAllowPortalSelfReg) {
      this.CanAllowPortalSelfReg = CanAllowPortalSelfReg;
      CanAllowPortalSelfReg__is_set = true;
    }
    ...
    /**
     * element : Cost_Centre__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Cost_Centre__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Cost_Centre__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Cost_Centre__c__is_set = false;

    private java.lang.String Cost_Centre__c;

    public java.lang.String getCost_Centre__c() {
      return Cost_Centre__c;
    }

    public void setCost_Centre__c(java.lang.String Cost_Centre__c) {
      this.Cost_Centre__c = Cost_Centre__c;
      Cost_Centre__c__is_set = true;
    }
    ...
    /**
     * element : Payroll_Number__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Payroll_Number__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Payroll_Number__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Payroll_Number__c__is_set = false;

    private java.lang.String Payroll_Number__c;

    public java.lang.String getPayroll_Number__c() {
      return Payroll_Number__c;
    }

    public void setPayroll_Number__c(java.lang.String Payroll_Number__c) {
      this.Payroll_Number__c = Payroll_Number__c;
      Payroll_Number__c__is_set = true;
    }
    ...
    /**
     * element : ServiceContracts of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo ServiceContracts__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ServiceContracts","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean ServiceContracts__is_set = false;
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, CanAllowPortalSelfReg__typeInfo, CanAllowPortalSelfReg, CanAllowPortalSelfReg__is_set);
       ...
       __typeMapper.writeString(__out, Cost_Centre__c__typeInfo, Cost_Centre__c, Cost_Centre__c__is_set);
       ...
       __typeMapper.writeString(__out, Payroll_Number__c__typeInfo, Payroll_Number__c, Payroll_Number__c__is_set);
       ...
       __typeMapper.writeObject(__out, ServiceContracts__typeInfo, ServiceContracts, ServiceContracts__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, CanAllowPortalSelfReg__typeInfo)) {
            setCanAllowPortalSelfReg((java.lang.Boolean)__typeMapper.readObject(__in, CanAllowPortalSelfReg__typeInfo, java.lang.Boolean.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Cost_Centre__c__typeInfo)) {
            setCost_Centre__c(__typeMapper.readString(__in, Cost_Centre__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Payroll_Number__c__typeInfo)) {
            setPayroll_Number__c(__typeMapper.readString(__in, Payroll_Number__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, ServiceContracts__typeInfo)) {
            setServiceContracts((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, ServiceContracts__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[Contact ");
      sb.append(super.toString());sb.append(" AcceptedEventRelations=");
      ...
      sb.append("'"+com.sforce.ws.util.Verbose.toString(AssistantName)+"'\n");
      sb.append(" AssistantPhone=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(AssistantPhone)+"'\n");
      ...
      sb.append(" Birthdate=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Birthdate)+"'\n");
      sb.append(" CampaignMembers=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(CampaignMembers)+"'\n");
      sb.append(" CanAllowPortalSelfReg=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(CanAllowPortalSelfReg)+"'\n");
      ...
      sb.append("'"+com.sforce.ws.util.Verbose.toString(CleanStatus)+"'\n");
      sb.append(" CombinedAttachments=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(CombinedAttachments)+"'\n");
      sb.append(" ContactCleanInfos=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(ContactCleanInfos)+"'\n");
      ...
      sb.append(" Cost_Centre__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Cost_Centre__c)+"'\n");
      sb.append(" CreatedBy=");
      ...
      sb.append("'"+com.sforce.ws.util.Verbose.toString(IsEmailBounced)+"'\n");
      sb.append(" Jigsaw=");
      ...
      sb.append("'"+com.sforce.ws.util.Verbose.toString(LastCURequestDate)+"'\n");
      sb.append(" LastCUUpdateDate=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(LastCUUpdateDate)+"'\n");
      ...
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingCity)+"'\n");
      sb.append(" MailingCountry=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingCountry)+"'\n");
      sb.append(" MailingLatitude=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingLatitude)+"'\n");
      sb.append(" MailingLongitude=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingLongitude)+"'\n");
      sb.append(" MailingPostalCode=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingPostalCode)+"'\n");
      sb.append(" MailingState=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingState)+"'\n");
      sb.append(" MailingStreet=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(MailingStreet)+"'\n");
      ...
      sb.append(" OtherCity=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherCity)+"'\n");
      sb.append(" OtherCountry=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherCountry)+"'\n");
      sb.append(" OtherLatitude=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherLatitude)+"'\n");
      sb.append(" OtherLongitude=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherLongitude)+"'\n");
      sb.append(" OtherPhone=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherPhone)+"'\n");
      sb.append(" OtherPostalCode=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherPostalCode)+"'\n");
      sb.append(" OtherState=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherState)+"'\n");
      sb.append(" OtherStreet=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OtherStreet)+"'\n");
      sb.append(" Owner=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Owner)+"'\n");
      sb.append(" OwnerId=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(OwnerId)+"'\n");
      sb.append(" Payroll_Number__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Payroll_Number__c)+"'\n");
      sb.append(" Phone=");
      ...
      sb.append(" ReportsTo=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(ReportsTo)+"'\n");
      sb.append(" ReportsToId=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(ReportsToId)+"'\n");
      sb.append(" Salutation=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Salutation)+"'\n");
      sb.append(" ServiceContracts=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(ServiceContracts)+"'\n");
      sb.append(" Shares=");

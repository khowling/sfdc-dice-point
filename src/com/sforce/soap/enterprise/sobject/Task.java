...
public class Task extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, CallDisposition__typeInfo)) {
            setCallDisposition(__typeMapper.readString(__in, CallDisposition__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, CallObject__typeInfo)) {
            setCallObject(__typeMapper.readString(__in, CallObject__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, CallType__typeInfo)) {
            setCallType(__typeMapper.readString(__in, CallType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, RecurrenceActivityId__typeInfo)) {
            setRecurrenceActivityId(__typeMapper.readString(__in, RecurrenceActivityId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, RecurrenceTimeZoneSidKey__typeInfo)) {
            setRecurrenceTimeZoneSidKey(__typeMapper.readString(__in, RecurrenceTimeZoneSidKey__typeInfo, java.lang.String.class));
        }
        __in.peekTag();

...
public class EmailMessage extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, ActivityId__typeInfo)) {
            setActivityId(__typeMapper.readString(__in, ActivityId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, BccAddress__typeInfo)) {
            setBccAddress(__typeMapper.readString(__in, BccAddress__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, CcAddress__typeInfo)) {
            setCcAddress(__typeMapper.readString(__in, CcAddress__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, FromAddress__typeInfo)) {
            setFromAddress(__typeMapper.readString(__in, FromAddress__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, FromName__typeInfo)) {
            setFromName(__typeMapper.readString(__in, FromName__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, ReplyToEmailMessageId__typeInfo)) {
            setReplyToEmailMessageId(__typeMapper.readString(__in, ReplyToEmailMessageId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, TextBody__typeInfo)) {
            setTextBody(__typeMapper.readString(__in, TextBody__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ToAddress__typeInfo)) {
            setToAddress(__typeMapper.readString(__in, ToAddress__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" ActivityId=");

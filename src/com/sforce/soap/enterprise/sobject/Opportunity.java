...
public class Opportunity extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, Fiscal__typeInfo)) {
            setFiscal(__typeMapper.readString(__in, Fiscal__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, ForecastCategory__typeInfo)) {
            setForecastCategory(__typeMapper.readString(__in, ForecastCategory__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, NextStep__typeInfo)) {
            setNextStep(__typeMapper.readString(__in, NextStep__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, StageName__typeInfo)) {
            setStageName(__typeMapper.readString(__in, StageName__typeInfo, java.lang.String.class));
        }
        __in.peekTag();

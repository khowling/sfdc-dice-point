 ...
 */
public class Event__c extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : ActivityDateTime__c of type {http://www.w3.org/2001/XMLSchema}dateTime
     * java type: java.util.Calendar
     */
    private static final com.sforce.ws.bind.TypeInfo ActivityDateTime__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ActivityDateTime__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

    private boolean ActivityDateTime__c__is_set = false;

    private java.util.Calendar ActivityDateTime__c;

    public java.util.Calendar getActivityDateTime__c() {
      return ActivityDateTime__c;
    }

    public void setActivityDateTime__c(java.util.Calendar ActivityDateTime__c) {
      this.ActivityDateTime__c = ActivityDateTime__c;
      ActivityDateTime__c__is_set = true;
    }

    /**
     * element : ActivityDate__c of type {http://www.w3.org/2001/XMLSchema}dateTime
     * java type: java.util.Calendar
     */
    private static final com.sforce.ws.bind.TypeInfo ActivityDate__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ActivityDate__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

    private boolean ActivityDate__c__is_set = false;

    private java.util.Calendar ActivityDate__c;

    public java.util.Calendar getActivityDate__c() {
      return ActivityDate__c;
    }

    public void setActivityDate__c(java.util.Calendar ActivityDate__c) {
      this.ActivityDate__c = ActivityDate__c;
      ActivityDate__c__is_set = true;
    }
    ...
    /**
     * element : DurationInMinutes__c of type {http://www.w3.org/2001/XMLSchema}double
     * java type: java.lang.Double
     */
    private static final com.sforce.ws.bind.TypeInfo DurationInMinutes__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","DurationInMinutes__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

    private boolean DurationInMinutes__c__is_set = false;

    private java.lang.Double DurationInMinutes__c;

    public java.lang.Double getDurationInMinutes__c() {
      return DurationInMinutes__c;
    }

    public void setDurationInMinutes__c(java.lang.Double DurationInMinutes__c) {
      this.DurationInMinutes__c = DurationInMinutes__c;
      DurationInMinutes__c__is_set = true;
    }
    ...
    /**
     * element : EndDateTime__c of type {http://www.w3.org/2001/XMLSchema}dateTime
     * java type: java.util.Calendar
     */
    private static final com.sforce.ws.bind.TypeInfo EndDateTime__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","EndDateTime__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

    private boolean EndDateTime__c__is_set = false;

    private java.util.Calendar EndDateTime__c;

    public java.util.Calendar getEndDateTime__c() {
      return EndDateTime__c;
    }

    public void setEndDateTime__c(java.util.Calendar EndDateTime__c) {
      this.EndDateTime__c = EndDateTime__c;
      EndDateTime__c__is_set = true;
    }

    /**
     * element : Event_Guest__r of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo Event_Guest__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Event_Guest__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean Event_Guest__r__is_set = false;

    private com.sforce.soap.enterprise.QueryResult Event_Guest__r;

    public com.sforce.soap.enterprise.QueryResult getEvent_Guest__r() {
      return Event_Guest__r;
    }

    public void setEvent_Guest__r(com.sforce.soap.enterprise.QueryResult Event_Guest__r) {
      this.Event_Guest__r = Event_Guest__r;
      Event_Guest__r__is_set = true;
    }
    ...
    /**
     * element : Petitioner__c of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Petitioner__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Petitioner__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean Petitioner__c__is_set = false;

    private java.lang.String Petitioner__c;

    public java.lang.String getPetitioner__c() {
      return Petitioner__c;
    }

    public void setPetitioner__c(java.lang.String Petitioner__c) {
      this.Petitioner__c = Petitioner__c;
      Petitioner__c__is_set = true;
    }

    /**
     * element : Petitioner__r of type {urn:sobject.enterprise.soap.sforce.com}User
     * java type: com.sforce.soap.enterprise.sobject.User
     */
    private static final com.sforce.ws.bind.TypeInfo Petitioner__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Petitioner__r","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

    private boolean Petitioner__r__is_set = false;

    private com.sforce.soap.enterprise.sobject.User Petitioner__r;

    public com.sforce.soap.enterprise.sobject.User getPetitioner__r() {
      return Petitioner__r;
    }

    public void setPetitioner__r(com.sforce.soap.enterprise.sobject.User Petitioner__r) {
      this.Petitioner__r = Petitioner__r;
      Petitioner__r__is_set = true;
    }
    ...
    /**
     * element : StartDateTime__c of type {http://www.w3.org/2001/XMLSchema}dateTime
     * java type: java.util.Calendar
     */
    private static final com.sforce.ws.bind.TypeInfo StartDateTime__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","StartDateTime__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

    private boolean StartDateTime__c__is_set = false;

    private java.util.Calendar StartDateTime__c;

    public java.util.Calendar getStartDateTime__c() {
      return StartDateTime__c;
    }

    public void setStartDateTime__c(java.util.Calendar StartDateTime__c) {
      this.StartDateTime__c = StartDateTime__c;
      StartDateTime__c__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Event__c");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, ActivityDateTime__c__typeInfo, ActivityDateTime__c, ActivityDateTime__c__is_set);
       __typeMapper.writeObject(__out, ActivityDate__c__typeInfo, ActivityDate__c, ActivityDate__c__is_set);
       ...
       __typeMapper.writeObject(__out, DurationInMinutes__c__typeInfo, DurationInMinutes__c, DurationInMinutes__c__is_set);
       __typeMapper.writeString(__out, Email__c__typeInfo, Email__c, Email__c__is_set);
       __typeMapper.writeObject(__out, EndDateTime__c__typeInfo, EndDateTime__c, EndDateTime__c__is_set);
       __typeMapper.writeObject(__out, Event_Guest__r__typeInfo, Event_Guest__r, Event_Guest__r__is_set);
       ...
       __typeMapper.writeString(__out, Petitioner__c__typeInfo, Petitioner__c, Petitioner__c__is_set);
       __typeMapper.writeObject(__out, Petitioner__r__typeInfo, Petitioner__r, Petitioner__r__is_set);
       ...
       __typeMapper.writeObject(__out, StartDateTime__c__typeInfo, StartDateTime__c, StartDateTime__c__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, ActivityDateTime__c__typeInfo)) {
            setActivityDateTime__c((java.util.Calendar)__typeMapper.readObject(__in, ActivityDateTime__c__typeInfo, java.util.Calendar.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ActivityDate__c__typeInfo)) {
            setActivityDate__c((java.util.Calendar)__typeMapper.readObject(__in, ActivityDate__c__typeInfo, java.util.Calendar.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, DurationInMinutes__c__typeInfo)) {
            setDurationInMinutes__c((java.lang.Double)__typeMapper.readObject(__in, DurationInMinutes__c__typeInfo, java.lang.Double.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, EndDateTime__c__typeInfo)) {
            setEndDateTime__c((java.util.Calendar)__typeMapper.readObject(__in, EndDateTime__c__typeInfo, java.util.Calendar.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Event_Guest__r__typeInfo)) {
            setEvent_Guest__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Event_Guest__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Location__c__typeInfo)) {
            setLocation__c(__typeMapper.readString(__in, Location__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Petitioner__c__typeInfo)) {
            setPetitioner__c(__typeMapper.readString(__in, Petitioner__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Petitioner__r__typeInfo)) {
            setPetitioner__r((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Petitioner__r__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, StartDateTime__c__typeInfo)) {
            setStartDateTime__c((java.util.Calendar)__typeMapper.readObject(__in, StartDateTime__c__typeInfo, java.util.Calendar.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Type__c__typeInfo)) {
            setType__c(__typeMapper.readString(__in, Type__c__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[Event__c ");
      sb.append(super.toString());sb.append(" ActivityDateTime__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(ActivityDateTime__c)+"'\n");
      sb.append(" ActivityDate__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(ActivityDate__c)+"'\n");
      ...
      sb.append(" DurationInMinutes__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(DurationInMinutes__c)+"'\n");
      sb.append(" Email__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Email__c)+"'\n");
      sb.append(" EndDateTime__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(EndDateTime__c)+"'\n");
      sb.append(" Event_Guest__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Event_Guest__r)+"'\n");
      sb.append(" Events=");
      ...
      sb.append(" Petitioner__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Petitioner__c)+"'\n");
      sb.append(" Petitioner__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Petitioner__r)+"'\n");
      ...
      sb.append(" StartDateTime__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(StartDateTime__c)+"'\n");

...
public class UserLicense extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, LicenseDefinitionKey__typeInfo)) {
            setLicenseDefinitionKey(__typeMapper.readString(__in, LicenseDefinitionKey__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" LicenseDefinitionKey=");

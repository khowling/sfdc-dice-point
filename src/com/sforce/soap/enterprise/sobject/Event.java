...
public class Event extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, GroupEventType__typeInfo)) {
            setGroupEventType(__typeMapper.readString(__in, GroupEventType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, ShowAs__typeInfo)) {
            setShowAs(__typeMapper.readString(__in, ShowAs__typeInfo, java.lang.String.class));
        }
        __in.peekTag();

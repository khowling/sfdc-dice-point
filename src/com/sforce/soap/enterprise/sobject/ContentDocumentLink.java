...
public class ContentDocumentLink extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, LinkedEntityId__typeInfo)) {
            setLinkedEntityId(__typeMapper.readString(__in, LinkedEntityId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ShareType__typeInfo)) {
            setShareType(__typeMapper.readString(__in, ShareType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" ContentDocument=");

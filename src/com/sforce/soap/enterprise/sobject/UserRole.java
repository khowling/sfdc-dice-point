...
public class UserRole extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, CaseAccessForAccountOwner__typeInfo)) {
            setCaseAccessForAccountOwner(__typeMapper.readString(__in, CaseAccessForAccountOwner__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ContactAccessForAccountOwner__typeInfo)) {
            setContactAccessForAccountOwner(__typeMapper.readString(__in, ContactAccessForAccountOwner__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, ForecastUserId__typeInfo)) {
            setForecastUserId(__typeMapper.readString(__in, ForecastUserId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, OpportunityAccessForAccountOwner__typeInfo)) {
            setOpportunityAccessForAccountOwner(__typeMapper.readString(__in, OpportunityAccessForAccountOwner__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ParentRoleId__typeInfo)) {
            setParentRoleId(__typeMapper.readString(__in, ParentRoleId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, PortalAccountId__typeInfo)) {
            setPortalAccountId(__typeMapper.readString(__in, PortalAccountId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, PortalAccountOwnerId__typeInfo)) {
            setPortalAccountOwnerId(__typeMapper.readString(__in, PortalAccountOwnerId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, PortalType__typeInfo)) {
            setPortalType(__typeMapper.readString(__in, PortalType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, RollupDescription__typeInfo)) {
            setRollupDescription(__typeMapper.readString(__in, RollupDescription__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[UserRole ");
      sb.append(super.toString());sb.append(" CaseAccessForAccountOwner=");

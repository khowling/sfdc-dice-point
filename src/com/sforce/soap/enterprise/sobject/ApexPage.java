...
public class ApexPage extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, ControllerKey__typeInfo)) {
            setControllerKey(__typeMapper.readString(__in, ControllerKey__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, ControllerType__typeInfo)) {
            setControllerType(__typeMapper.readString(__in, ControllerType__typeInfo, java.lang.String.class));
        }
        __in.peekTag();

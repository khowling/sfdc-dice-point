...
public class Account extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : AccountTeamMembers of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo AccountTeamMembers__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AccountTeamMembers","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean AccountTeamMembers__is_set = false;

    private com.sforce.soap.enterprise.QueryResult AccountTeamMembers;

    public com.sforce.soap.enterprise.QueryResult getAccountTeamMembers() {
      return AccountTeamMembers;
    }

    public void setAccountTeamMembers(com.sforce.soap.enterprise.QueryResult AccountTeamMembers) {
      this.AccountTeamMembers = AccountTeamMembers;
      AccountTeamMembers__is_set = true;
    }
    ...
    /**
     * element : Customer_Products__r of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo Customer_Products__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Customer_Products__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean Customer_Products__r__is_set = false;

    private com.sforce.soap.enterprise.QueryResult Customer_Products__r;

    public com.sforce.soap.enterprise.QueryResult getCustomer_Products__r() {
      return Customer_Products__r;
    }

    public void setCustomer_Products__r(com.sforce.soap.enterprise.QueryResult Customer_Products__r) {
      this.Customer_Products__r = Customer_Products__r;
      Customer_Products__r__is_set = true;
    }
    ...
    /**
     * element : Servicios__r of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo Servicios__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Servicios__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean Servicios__r__is_set = false;

    private com.sforce.soap.enterprise.QueryResult Servicios__r;

    public com.sforce.soap.enterprise.QueryResult getServicios__r() {
      return Servicios__r;
    }

    public void setServicios__r(com.sforce.soap.enterprise.QueryResult Servicios__r) {
      this.Servicios__r = Servicios__r;
      Servicios__r__is_set = true;
    }
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, AccountTeamMembers__typeInfo, AccountTeamMembers, AccountTeamMembers__is_set);
       ...
       __typeMapper.writeObject(__out, Customer_Products__r__typeInfo, Customer_Products__r, Customer_Products__r__is_set);
       ...
       __typeMapper.writeObject(__out, Servicios__r__typeInfo, Servicios__r, Servicios__r__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, AccountTeamMembers__typeInfo)) {
            setAccountTeamMembers((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, AccountTeamMembers__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Customer_Products__r__typeInfo)) {
            setCustomer_Products__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Customer_Products__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Servicios__r__typeInfo)) {
            setServicios__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Servicios__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[Account ");
      sb.append(super.toString());sb.append(" AccountCleanInfos=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(AccountCleanInfos)+"'\n");
      ...
      sb.append(" AccountTeamMembers=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(AccountTeamMembers)+"'\n");
      ...
      sb.append(" Customer_Products__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Customer_Products__r)+"'\n");
      sb.append(" DandbCompany=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(DandbCompany)+"'\n");
      sb.append(" DandbCompanyId=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(DandbCompanyId)+"'\n");
      ...
      sb.append(" IsCustomerPortal=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(IsCustomerPortal)+"'\n");
      sb.append(" IsDeleted=");
      ...
      sb.append(" NaicsDesc=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(NaicsDesc)+"'\n");
      sb.append(" Name=");
      ...
      sb.append(" Servicios__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Servicios__r)+"'\n");
      sb.append(" Shares=");

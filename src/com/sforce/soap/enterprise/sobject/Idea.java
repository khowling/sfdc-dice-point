...
public class Idea extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : Idea_in_Action__c of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Idea_in_Action__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Idea_in_Action__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean Idea_in_Action__c__is_set = false;

    private java.lang.String Idea_in_Action__c;

    public java.lang.String getIdea_in_Action__c() {
      return Idea_in_Action__c;
    }

    public void setIdea_in_Action__c(java.lang.String Idea_in_Action__c) {
      this.Idea_in_Action__c = Idea_in_Action__c;
      Idea_in_Action__c__is_set = true;
    }

    /**
     * element : Idea_in_Action__r of type {urn:sobject.enterprise.soap.sforce.com}Idea
     * java type: com.sforce.soap.enterprise.sobject.Idea
     */
    private static final com.sforce.ws.bind.TypeInfo Idea_in_Action__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Idea_in_Action__r","urn:sobject.enterprise.soap.sforce.com","Idea",0,1,true);

    private boolean Idea_in_Action__r__is_set = false;

    private com.sforce.soap.enterprise.sobject.Idea Idea_in_Action__r;

    public com.sforce.soap.enterprise.sobject.Idea getIdea_in_Action__r() {
      return Idea_in_Action__r;
    }

    public void setIdea_in_Action__r(com.sforce.soap.enterprise.sobject.Idea Idea_in_Action__r) {
      this.Idea_in_Action__r = Idea_in_Action__r;
      Idea_in_Action__r__is_set = true;
    }

    /**
     * element : Ideas__r of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo Ideas__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Ideas__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean Ideas__r__is_set = false;
    ...
    /**
     * element : Update__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Update__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Update__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Update__c__is_set = false;

    private java.lang.String Update__c;

    public java.lang.String getUpdate__c() {
      return Update__c;
    }

    public void setUpdate__c(java.lang.String Update__c) {
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeString(__out, Idea_in_Action__c__typeInfo, Idea_in_Action__c, Idea_in_Action__c__is_set);
       __typeMapper.writeObject(__out, Idea_in_Action__r__typeInfo, Idea_in_Action__r, Idea_in_Action__r__is_set);
       __typeMapper.writeObject(__out, Ideas__r__typeInfo, Ideas__r, Ideas__r__is_set);
       ...
       __typeMapper.writeString(__out, Update__c__typeInfo, Update__c, Update__c__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Idea_in_Action__c__typeInfo)) {
            setIdea_in_Action__c(__typeMapper.readString(__in, Idea_in_Action__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Idea_in_Action__r__typeInfo)) {
            setIdea_in_Action__r((com.sforce.soap.enterprise.sobject.Idea)__typeMapper.readObject(__in, Idea_in_Action__r__typeInfo, com.sforce.soap.enterprise.sobject.Idea.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Ideas__r__typeInfo)) {
            setIdeas__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Ideas__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Update__c__typeInfo)) {
            setUpdate__c(__typeMapper.readString(__in, Update__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[Idea ");
      sb.append(super.toString());sb.append(" Age__c=");
      ...
      sb.append(" Idea_in_Action__c=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Idea_in_Action__c)+"'\n");
      sb.append(" Idea_in_Action__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Idea_in_Action__r)+"'\n");
      sb.append(" Ideas__r=");
      sb.append("'"+com.sforce.ws.util.Verbose.toString(Ideas__r)+"'\n");
      sb.append(" IsDeleted=");

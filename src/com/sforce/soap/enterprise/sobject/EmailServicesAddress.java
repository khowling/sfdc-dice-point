...
public class EmailServicesAddress extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, EmailDomainName__typeInfo)) {
            setEmailDomainName(__typeMapper.readString(__in, EmailDomainName__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, FunctionId__typeInfo)) {
            setFunctionId(__typeMapper.readString(__in, FunctionId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, LocalPart__typeInfo)) {
            setLocalPart(__typeMapper.readString(__in, LocalPart__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, RunAsUserId__typeInfo)) {
            setRunAsUserId(__typeMapper.readString(__in, RunAsUserId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" AuthorizedSenders=");
